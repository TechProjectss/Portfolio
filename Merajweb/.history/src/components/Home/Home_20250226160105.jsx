...
const Home = () => {
    ...
    useEffect(() => {
        let headingIndex = 0;
        const headingText = slides[currentSlide]?.heading || ""; // ✅ Avoids undefined

        setTypedHeading("");

        if (!headingText) return; // ✅ Prevents typing undefined
        ...
        return () => clearInterval(headingInterval); // ✅ Ensures cleanup
    }, [currentSlide]);
