...
import "./Programs.css";
import img1 from "../../assets/hom1.jpg"; // Replace with actual image path
import img2 from "../../assets/int7.jpg"; // Replace with actual image path
import img3 from "../../assets/int2.jpg"; // Replace with actual image path
import img4 from "../../assets/int5.jpg"; // Replace with actual image path
import img5 from "../../assets/int4.jpg"; // Replace with actual image path
